...
List<GetPage> getPageRoute() {
  var routes = [
    ...
    // Dashboard
    GetPage(name: '/dashboard/ecommerce', page: () => const EcommerceScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/crm', page: () => const CrmScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/job', page: () => const JobScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/project', page: () => const ProjectScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/analytics', page: () => const AnalyticsScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/crypto', page: () => const CryptoScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/dashboard/sales', page: () => const SalesScreen(), middlewares: [AuthMiddleware()]),

    // Apps
    GetPage(name: '/app/kanban_board', page: () => KanBanBoardScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/calendar', page: () => CalendarScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/chat', page: () => ChatScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/file_manager', page: () => FileManagerScreen(), middlewares: [AuthMiddleware()]),
    //Ecommerce
    GetPage(name: '/app/ecommerce/product', page: () => ProductScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/ecommerce/add_product', page: () => AddProductScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/ecommerce/product_detail', page: () => ProductDetailScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/app/ecommerce/customer', page: () => CustomerScreen(), middlewares: [AuthMiddleware()]),
    ...
    // Base UI
    GetPage(name: '/widget/toast', page: () => ToastMessageScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/buttons', page: () => ButtonsScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/modal', page: () => ModalScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/tabs', page: () => TabsScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/loader', page: () => LoadersScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/dialog', page: () => DialogsScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/carousel', page: () => CarouselsScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/drag_n_drop', page: () => DragNDropScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/widget/notification', page: () => NotificationScreen(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: '/other/map', page: () => MapScreen(), middlewares: [AuthMiddleware()]),
    GetPage(name: '/other/syncfusion_chart', page: () => SyncFusionChartScreen(), middlewares: [AuthMiddleware()]),
