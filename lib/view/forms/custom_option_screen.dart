import 'package:maxdash/controller/forms/custom_option_controller.dart';
              ...
              Padding(
                ...
                child: MyFlex(
                  children: [
                    ...
                    MyFlexItem(
                      sizes: 'lg-6',
                      child: _customOptionRadiosWithIcons(),
                    ),
                    MyFlexItem(
                      sizes: 'lg-6',
                      child: _customOptionsRadioWithImages(),
                    ),
                  ],
                ),
              ),
  ...
  Widget _customOptionsRadioWithImages() {
    ...
    return MyCard.bordered(
      ...
      child: Column(
        ...
        children: [
          MyText.titleMedium(
            "Custom Options Radio With Images",
            fontWeight: 600,
          ),
          MySpacing.height(16),
          Wrap(
  ...
  Widget _customBasicRadio() {
    ...
    return MyCard.bordered(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyText.titleMedium("Custom Basic Radio Button", fontWeight: 600),
          MySpacing.height(12),
          Row(
            children: [
