...
class _BasicInputScreenState extends State<BasicInputScreen>
              ...
              children: [
                Row(
                  children: [
                    SizedBox(
                      width: 180,
                      child: MyText.labelLarge("Floating Label Type"),
                    ),
                    PopupMenuButton(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Disabled"),
                            ),
                            Switch(
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Read Only"),
                            ),
                            Switch(
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Helper Text"),
                            ),
                            Switch(
                      ...
                      children: [
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Inline Text"),
                            ),
                            Switch(
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Prefix Icon"),
                            ),
                            Switch(
                        ...
                        Row(
                          children: [
                            SizedBox(
                              width: 100,
                              child: MyText.labelLarge("Suffix Icon"),
                            ),
                            Switch(
                  ...
                  MyText.labelMedium(
                    controller.selectedTime != null
                        ? timeFormatter.format(
                            DateTime.now().applied(controller.selectedTime!),
                          )
                        : "Select Time",
                    fontWeight: 600,
                    color: colorScheme.primary,
