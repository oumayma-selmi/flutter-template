                  ...
                  children: [
                    MyFlexItem(
                      child: Column(
                        children: [
                          MyText.bodyLarge(
                            "Find your perfect plan: Transparent Pricing Tailored to your needs",
                            fontWeight: 600,
                          ),
                          MySpacing.height(20),
                          Row(
    ...
    return MyContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              children: [
                TextSpan(
                  text: "\$$price/",
                  style: MyTextStyle.displaySmall(fontWeight: 900),
                ),
                TextSpan(
                  text: "Month",
          ...
          MySpacing.height(16),
          MyText.bodyMedium(
            "Everything in the ${pricingType.toLowerCase()} plan plus...",
            fontWeight: 600,
          ),
          MySpacing.height(16),
